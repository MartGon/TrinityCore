    ...
    public:
        spell_hun_camouflage() : SpellScriptLoader("spell_hun_camouflage") { }
            ...
            PrepareAuraScript(spell_hun_camouflage_AuraScript);
                ...
                bool Validate(SpellInfo const* /*spellInfo*/) override
                 {
                /*if (!sSpellMgr->GetSpellInfo(SPELL_HUNTER_CAMOUFLAGE_AURA))
                     return false;*/
                return true;
                }
                ...
                void OnApply(AuraEffect const* aurEff, AuraEffectHandleModes mode)
                 {
                    ...
                    if (Unit* caster = GetCaster())
                         {
                        //caster->CastSpell(caster, SPELL_HUNTER_CAMOUFLAGE_AURA, true);
                ...
                void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/){
                    ...
                    if (Unit* caster = GetCaster())
                    {
                        ...
                        if (Unit* pet = caster->GetGuardianPet())
                            ...
                            caster->GetOwner()->RemoveAura(SPELL_HUNTER_CAMOUFLAGE_AURA);
                    }
                }
    ...
    public:
        ...
        class spell_hun_flanking_strike_SpellScript : public SpellScript
        {
            ...
            void HandleCooldowns()
            {
                ...
                if (AuraEffect *aura = GetCaster()->GetAuraEffect(191384, EFFECT_0)) 
                {
                    ...
                    {
                    case 81:
                        pet->CastSpell(target, 191414, true);
                        break;
                    case 79:
        ...
        class spell_hun_flanking_strike_pet_SpellScript : public SpellScript
        {
            ...
            void CalculateDamage(SpellEffIndex effIndex)
            {
                ...
                if (Unit *target = GetHitUnit()) 
                {
                    ...
                    std::cout << "La versatilidad es" << vers << "\n";
    ...
    class spell_hun_aspect_eagle_SpellScript : public SpellScript
    {
        ...
        void HandleAfterCast()
        {
            if (Unit *pet = GetCaster()->GetGuardianPet()) 
                if (AuraEffect const* aurEff = GetCaster()->GetAuraEffectOfRankedSpell(231555, EFFECT_0))
                {
...
// Tar trap starter areatrigger 187699
