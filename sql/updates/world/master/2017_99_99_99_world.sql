...
DELETE FROM `spell_areatrigger` WHERE `AreaTriggerId`=3157;
...
DELETE FROM `spell_areatrigger` WHERE `AreaTriggerId`=3154;
INSERT INTO `spell_areatrigger` (`SpellMiscId`, `AreaTriggerId`, `MoveCurveId`, `ScaleCurveId`, `MorphCurveId`, `FacingCurveId`, `DecalPropertiesId`, `TimeToTarget`, `TimeToTargetScale`, `VerifiedBuild`) VALUES
...
DELETE FROM `spell_areatrigger` WHERE `AreaTriggerId`=3158;
INSERT INTO `spell_areatrigger` (`SpellMiscId`, `AreaTriggerId`, `MoveCurveId`, `ScaleCurveId`, `MorphCurveId`, `FacingCurveId`, `DecalPropertiesId`, `TimeToTarget`, `TimeToTargetScale`, `VerifiedBuild`) VALUES
...
-- 201078 Snake Hunter
DELETE FROM `spell_script_names` WHERE `spell_id`=201078;
...
DELETE FROM `spell_areatrigger` WHERE `AreaTriggerId`=3161;
INSERT INTO `spell_areatrigger` (`SpellMiscId`, `AreaTriggerId`, `MoveCurveId`, `ScaleCurveId`, `MorphCurveId`, `FacingCurveId`, `DecalPropertiesId`, `TimeToTarget`, `TimeToTargetScale`, `VerifiedBuild`) VALUES
(2392, 3161, 0, 0, 0, 0, 0, 0, 60000, 23911);

-- 191241 Sticky Bomb
DELETE FROM `spell_script_names` WHERE `spell_id`=191241;
...
DELETE FROM `spell_areatrigger` WHERE `AreaTriggerId`=3159;
INSERT INTO `spell_areatrigger` (`SpellMiscId`, `AreaTriggerId`, `MoveCurveId`, `ScaleCurveId`, `MorphCurveId`, `FacingCurveId`, `DecalPropertiesId`, `TimeToTarget`, `TimeToTargetScale`, `VerifiedBuild`) VALUES
...
DELETE FROM `spell_areatrigger` WHERE `AreaTriggerId`=3160;
INSERT INTO `spell_areatrigger` (`SpellMiscId`, `AreaTriggerId`, `MoveCurveId`, `ScaleCurveId`, `MorphCurveId`, `FacingCurveId`, `DecalPropertiesId`, `TimeToTarget`, `TimeToTargetScale`, `VerifiedBuild`) VALUES
